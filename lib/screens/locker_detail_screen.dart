...
class LockerDetailScreen extends StatefulWidget {
  ...
  final int userId;
  const LockerDetailScreen({super.key, required this.location, this.userId = 0});
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => BookingSummaryScreen(
                          ...
                          lockerSize: _lockers[_selectedLocker!].size,
                          pricePerHour: _lockers[_selectedLocker!].price,
